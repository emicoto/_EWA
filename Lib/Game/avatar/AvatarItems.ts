import { AvItems, Hairs, Emote } from "./Avatars";
import { A } from ".";
...
A.InitInnerTop = function () {
	AvItems.add("underup", "", "吊带背心", "一件简单的吊带背心，给胸部小小的你带来些许安全感。", "f")
		.setEnglish("camisole", "A simple camisole, can give you a little bit comfort.")
		.setCost(30)
		.setWarmth(-0.2)
		.setSlot(["torso"]);

	AvItems.add("underup", "", "胸罩", "一件设计朴素的胸罩。", "f")
		.setEnglish("bra", "A simple designed bra.")
		.setCost(60);
};

//内衣下身
A.InitInnerBottom = function () {
	AvItems.add("underbt", "boxer", "四角内裤", "一条简单的四角内裤。", "m")
		.setEnglish("boxer brief", "A simple boxer brief.")
		.customColor()
		.setCost(12)
		.setWarmth(-0.1);

	AvItems.add("underbt", "pantie", "内裤", "一款简单朴素的内裤。", "f")
...
A.InitLegItems = function () {
	AvItems.add("shoes", "sportshoes", "运动鞋", "一双普通的白色运动鞋。")
	...
	AvItems.add("shoes", "highheel", "高跟鞋", "一双简单设计的高跟鞋。", "f")
	...
	AvItems.add("shoes", "", "皮鞋", "一双设计简单的皮鞋。")
	...
	AvItems.add("socks", "sportsocks", "运动短袜", "一对简单的运动袜。")
...
A.InitOutfitTops = function () {
	AvItems.add("upper", "Tshirt", "T恤", "一键简单的T恤。并不能给你多少保护，但总比没有好。")
		.setEnglish(
			"T-shirt",
	...
	AvItems.add("upper", "shirt", "衬衫", "一件简单的西式长袖衬衫。浅浅的暗纹给你增加了些许气质。")
		.setEnglish(
			"business shirt",
	...
	AvItems.add("upper", "slpshortup", "短袖睡衣", "一件设计简单的睡衣。轻柔透气的布料给你带来好梦。")
...
A.InitOutfitBottoms = function () {
	AvItems.add("bottom", "shortpant", "短裤", "一条简单的短裤。")
	...
	AvItems.add("bottom", "shortskirt", "短裙", "一条简单的短裙。", "f")
	...
	AvItems.add("bottom", "bskirt", "西装短裙", "一条简单的西式短裙。毕竟是廉价款，不能指望耐久度。", "f")
	...
	AvItems.add("bottom", "slpshortbt", "睡衣短裤", "一件设计简单的睡衣短裤。轻柔透气的布料给你带来好梦。")
		.setEnglish("summer pajamas", "A simple design pajamas. The light and breathable fabric brings you good dreams.")
		.setTags(["日常", "睡衣"])
		.hasPDif()
		.setCost(80)
	...
	AvItems.add("bottom", "", "长裤", "一件设计简单的长裤。舒适宽松的布料，修身的设计，穿着很是得体。")
		.setEnglish(
			"pant",
