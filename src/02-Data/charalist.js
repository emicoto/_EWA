...
F.InitNPC = function () {
	Chara.add("npc", "human", "余安", "m")
		...
		.Hairlength(50, 50)
		.setTrait(["自由业"])
		.Base({ 力量: 8, 智力: 14, 意志: 15, 灵感: 16, 魅力: 12 })
		.Abl("格斗", 2)
		.Abl("健身", 3)
		.Abl("跑步", 3)
		.Abl("科学", 8)
		...
		.Description([
			"居住在主角对门的自由设计师。", "A freelance designer who living opposite of your appartment.",
		]);
	...
	Chara.add("npc", "dracons", "娜娜莉·爱索斯", "i")
		...
		.Hairlength(300, 500)
		.Base({ 力量: 8, 体质: 10, 敏捷: 14, 智力: 16, 意志: 12, 灵感: 14, 魅力: 14 })
		.Abl("格斗", 7)
		.Abl("健身", 5)
		.Abl("跑步", 7)
		.Abl("科学", 15)
